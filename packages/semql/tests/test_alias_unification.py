"""One output-alias convention, not two.

The output-column collision logic existed twice —
...
queries, but diverge under input-aliases: referencing
...
def test_plan_aliases_unique_under_input_alias() -> None:
    """Referencing a dimension by its input alias must not defeat collision
