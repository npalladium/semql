"""Refuse silent cross-cube type coercion on federated joins.

This sits in the correctness tier:
...
``on`` clause (the raw-SQL escape hatch) whose key types SemQL
...
# ---------------------------------------------------------------------------
# Planner prompt surfacing ("surfaced in the planner prompt")
# ---------------------------------------------------------------------------
