"""Wire the rest of the compile pipeline through the LogicalPlan.

An earlier slice (test_plan_wiring.py) proved the time-block reads from
...
work so this lands fully done rather than a half-finished
follow-up.
"""
