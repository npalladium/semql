"""Tests for the result cache + observability hooks on the engine.

The result cache is a paired feature:
...
The cache is *in-process* — it explicitly defers distributed cache
